  ...
  return (
    <div className="px-4 sm:px-8 md:px-16 lg:px-28 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {/* Product 1 */}
        <div className="relative flex flex-col bg-gray-100 rounded-lg p-4">
          <span className="absolute top-2 left-2 bg-green-400 text-white text-xs px-2 py-1 rounded">New</span>
          <Image
        ...
        {/* Product 2 */}
        <div className="relative flex flex-col bg-gray-100 rounded-lg p-4">
          <span className="absolute top-2 left-2 bg-orange-400 text-white text-xs px-2 py-1 rounded">Sales</span>
          <Image
